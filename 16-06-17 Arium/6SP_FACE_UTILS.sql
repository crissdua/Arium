...
/***** OPCION 17 *****/
	IF (:opcion = 17) THEN
		select "U_ESTADO_FACE" from OINV WHERE  "DocEntry"=:param1 and ifnull("U_ESTADO_FACE",'P')='A';
	END IF;
/***** OPCION 18 *****/
	IF (:opcion = 18) THEN
		select "U_ESTADO_FACE" from ORIN WHERE  "DocEntry"=:param1 and ifnull("U_ESTADO_FACE",'P')='A';
	END IF;
/***** OPCION 19 *****/
	IF (:opcion = 19) THEN
		select "U_ESTADO_FACE" from OPCH WHERE  "DocEntry"=:param1 and ifnull("U_ESTADO_FACE",'P')='A';
	END IF;	
/***** OPCION 20 *****/
	IF (:opcion = 20) THEN
...
/***** OPCION 39 *****/
	IF (:opcion = 39) THEN
		...
		select * FROM "_SYS_BIC"."AddonFACE/OINV" WHERE "DocEntry"=:param1;
	END IF;	
/***** OPCION 40 *****/
	IF (:opcion = 40) THEN
		--SELECT * FROM ORIN WHERE "DocEntry"=:param1;
		select * FROM "_SYS_BIC"."AddonFACE/ORINOINV" WHERE "DocEntry"=:param1;
	END IF;	
/***** OPCION 41 *****/
	IF (:opcion = 41) THEN
	select * from "_SYS_BIC"."AddonFACE/OCRD" WHERE "CardCode" = :param1;
...
/***** OPCION 43 *****/
	IF (:opcion = 43) THEN
		SELECT * FROM "_SYS_BIC"."AddonFACE/OADM" WHERE "CompnyName" = :param1;
...
/***** OPCION 45 *****/
	IF (:opcion = 45) THEN
	--select * from "_SYS_BIC"."AddonFACE/COUNTRY";
		--select * from "ADM1";
	END IF;
/***** OPCION 46 *****/
	IF (:opcion = 46) THEN
...
/***** OPCION 49 *****/
	IF (:opcion = 49) THEN
		select * FROM "_SYS_BIC"."AddonFACE/RIN1" WHERE "DocEntry" = :param1;
		--SELECT * FROM "RIN1" WHERE "DocEntry" = :param1;
	END IF;
/***** OPCION 50 *****/
	IF (:opcion = 50) THEN
		select * from "_SYS_BIC"."AddonFACE/INV1" WHERE "DocEntry" = :param1;
