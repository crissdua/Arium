...
Module Utils
    ...
    Public Function TotalExcento(ByVal docEntry As String, ByVal Tipo As String) As Decimal
        ...
        Try
            ...
            Return TraeDato(sql).Rows(0).ItemArray(0).ToString()
    ...
    Public Sub EnviaDocumentoInFile(ByVal OCompany As SAPbobsCOM.Company, ByVal SBO_Application As SAPbouiCOM.Application, ByVal Tipo As String, ByVal CurrSerie As String, ByVal CurrDoc As String, ByVal CurrSerieName As String, ByVal Pais As String, ByVal DocEntry As String, Optional ByVal ProcesarBatch As Boolean = False)
        ...
        Try
            If ValidaSerie(OCompany, SBO_Application, CurrSerie, ProcesarBatch) Then
                ...
                End If
                CurrDoc = obOINV.Rows(0).Item("U_NoDocto").ToString()
                obOCRD = EjecutaSqlTable("CALL SP_FACE_UTILS('41','" & obOINV.Rows(0)("CardCode") & "','','','','')")
                'obOCRD1s = EjecutaSqlTable("CALL SP_FACE_UTILS('42','" & obOINV.Rows(0)("CardCode") & "','','','','')")
                ...
                Dim table2 As DataTable = EjecutaSqlTable("CALL SP_FACE_IT_DATOS_ENCABEZADO2('" & DocEntry & "','" & Tipo & "')")
                ...
                Dim TipoDoc As New DataTable
                TipoDoc = TraeDato("CALL SP_FACE_UTILS('46','" & obRES.Rows(0)("U_TIPO_DOC").ToString & "','','','','')")
                dte.tipoDocumento = TipoDoc.Rows(0)(0).ToString.Split("-")(0).ToString  '.ToString.Split("-")(0).  'TipoDoc.Rows(0)(0).ToString.Split("-")(0).ToString
                log += ContruyeLog(SBO_Application, "tipoDocumento", dte.tipoDocumento) & vbNewLine
                dte.nitComprador = obOCRD.Rows(0)("AddID").ToString
                'dte.nitComprador = obOINV.Rows(0)("U_NitFactura").ToString
                'dte.nitComprador = "1234567"
                log += ContruyeLog(SBO_Application, "nitComprador", obOINV.Rows(0)("U_NitFactura").ToString) & vbNewLine
                ...
                'Dim TipoMuni As New DataTable
                'TipoMuni = TraeDato("CALL SP_FACE_UTILS('47','" & obOCRD.Rows(0)("CardCode").ToString & "','','','','')")
                dte.municipioComprador = "municipio" 'TipoMuni.Rows(0)(0).ToString
                log += ContruyeLog(SBO_Application, "municipioComprador", dte.municipioComprador) & vbNewLine
                ...
                'Dim TipoDepto As New DataTable
                'TipoDepto = TraeDato("CALL SP_FACE_UTILS('48','" & obOCRD.Rows(0)("CardCode").ToString & "','','','','')")
                dte.departamentoComprador = "Depto" 'TipoDepto.Rows(0)(0).ToString
                ...
                log += ContruyeLog(SBO_Application, "departamentoComprador", dte.departamentoComprador) & vbNewLine
                ...
                dte.municipioVendedor = obOADM.Rows(0)("Country").ToString
                ...
                For Each obProd As DataRow In obOINV1.Rows
                    ...
                    deta.precioUnitario = obProd("Price")
                    ...
                    deta.importeNetoGravado = obProd("Price")
                    ...
                    Try
                        ...
                        deta.unidadMedida = "UND" 'TraeDato("CALL SP_FACE_UTILS('51','" & obProd("U_UnidadMedida").ToString & "','','','','')")
   ...
   ByVal FullPath As String, _
    ...
    Public Function TraeDataset(ByVal Sql As String) As DataSet
        Try
            ...
            '    For ColCount = 0 To RecSet.Fields.Count - 1
            ...
            '            NewRow.Item(RecSet.Fields.Item(ColCount).Name) = RecSet.Fields.Item(ColCount).Value
